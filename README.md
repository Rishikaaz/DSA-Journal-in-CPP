...
[![Language: C++20](https://img.shields.io/badge/Language-C%2B%2B20-00599C?style=flat-square&logo=cplusplus)](https://en.cppreference.com/)
...
* **Modern C++ Standards:** Utilizing STL containers, iterators, smart idioms, and standard algorithms (`std::sort`, `std::unordered_map`, two-pointers, sliding window techniques).
